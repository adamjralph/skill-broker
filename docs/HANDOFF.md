...
**Open frontier** (open, no open blocker, unassigned): #58 (measured expansion), gated by #57 which is now built and rehearsed. The wayfinder map #1 and the Stage 9 retirement review #23 remain open.
