...
**Open frontier** (open, no open blocker, unassigned): #58 (measured expansion). #57 is closed. The wayfinder map #1 and the Stage 9 retirement review #23 remain open.
...
- **#58 Measured expansion** — the procedure and the next batch.
